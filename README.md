...
| [unsloth-minimal-training](notebooks/unsloth-minimal-training.ipynb) | CUDA-only Unsloth LoRA fine-tuning on `tsilva/banking77`, with stratified train/validation split, validation-loss early stopping, W&B prediction logging, and final test-set intent accuracy | |
